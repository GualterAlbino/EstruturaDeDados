...
int Contador1;  //Variável utilizada para armazenar a quantidade de elementos na Fila
...
void Fila_Construtor()
{
  ...
  Contador1 = 0;   //Armazena a quantidade de elementos na Fila
...
int Fila_Tamanho()
{
    return Contador1;  //É retornado o contador de elementos, manipulado nos métodos de Enfileirar e Desenfileirar
}
...
bool Fila_Enfileirar(TipoDado1 Elemento)
{
   ...
   else
   {
          ...
          Contador1++;       //Um elemento foi enfileirado, portanto deve-se incrementar o contador de elementos da Fila
...
bool Fila_Desenfileirar(TipoDado1 &Elemento)
{
     ...
     if(!Fila_Vazia()){  //Se a Fila não estiver vazia, podemos remover algum elemento
        ...
        Contador1--;  //"Contador" é decrementado para indicar que um elemento foi removido da Fila (desenfileirado)
...
bool Fila_Frente(TipoDado1 &Elemento)
{
